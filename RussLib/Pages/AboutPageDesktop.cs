...
namespace RussLib.Pages
{
    ...
    internal class AboutPageDesktop : AboutPageBase
    {
        ...
        public AboutPageDesktop()
        {
            DefaultStyleKey = typeof(AboutPageDesktop);
        }
        ...
        protected override void OnApplyTemplate()
        {
            ...
            if (_partFeedback != null)
            {
                _partFeedback.Click += (s, a) => 
                {
                    FeedbackPopup.LoadFeedback();
                };
            }
